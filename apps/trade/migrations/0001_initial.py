# Generated by Django 2.2.2 on 2019-06-05 15:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_status', models.CharField(choices=[('TRADE_SUCCESS', '交易完成'), ('REFUNDED', '已退款'), ('WAIT_REFUND', '待退款'), ('TRADE_CLOSED', '交易关闭'), ('WAIT_COMMENT', '待评价'), ('WAIT_ARRIVE', '待收货'), ('WAIT_SEND', '待发货'), ('PAY_ING', '待付款')], default='PAY_ING', max_length=30, verbose_name='订单状态')),
